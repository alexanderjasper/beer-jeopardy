...
namespace Oljeopardy.Data.Migrations
{
    ...
    [Migration("20171112131520_FixedForeignKeyProblems")]
    partial class FixedForeignKeyProblems
    {
            ...
            modelBuilder.Entity("Oljeopardy.Models.Game", b =>
                {
                    ...
                    b.HasIndex("SelectedGameCategoryId")
                        .IsUnique()
                        .HasFilter("[SelectedGameCategoryId] IS NOT NULL");
            ...
            modelBuilder.Entity("Oljeopardy.Models.Game", b =>
                {
                    b.HasOne("Oljeopardy.Models.GameCategory", "SelectedGameCategory")
                        .WithOne("Game")
                        .HasForeignKey("Oljeopardy.Models.Game", "SelectedGameCategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
