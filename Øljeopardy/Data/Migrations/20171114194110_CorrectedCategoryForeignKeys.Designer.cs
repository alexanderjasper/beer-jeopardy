...
namespace Oljeopardy.Data.Migrations
{
    ...
    [Migration("20171114194110_CorrectedCategoryForeignKeys")]
    partial class CorrectedCategoryForeignKeys
    {
            ...
            modelBuilder.Entity("Oljeopardy.Models.GameCategory", b =>
                {
                    ...
                    b.HasOne("Oljeopardy.Models.Game", "Game")
                        .WithOne("SelectedGameCategory")
                        .HasForeignKey("Oljeopardy.Models.GameCategory", "GameId")
                        .OnDelete(DeleteBehavior.Restrict);
